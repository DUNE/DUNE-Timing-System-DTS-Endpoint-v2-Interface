...
\title{DUNE Timing System (DTS) Endpoint v2 Firmware Interface }

\author[1]{D.M.Newbold}
...
\keywords{DUNE,Timing System,Firmware}

\begin{abstract}
    This document describes the interface to the endpoint firmware for the DUNE/DCSK Timing System (DTS).

    \textsc{document source:}\\
    {\bf EDMS:} \href{https://edms.cern.ch/document/2395364}{2395364} \\
    {\bf Overleaf:}  \url{https://www.overleaf.com/read/mcbbkqmscthd#bac917}
...
\begin{versionhistory}
  \vhEntry{v1 - v5}{09/June/22}{DMN}{created}
  \vhEntry{v6}{17/Oct/25}{DGC}{Ported from Google Document to LateX. Minor edits.}
\end{versionhistory}
...
\begin{itemize}
\item Recovery of the DUNE 62.5MHz clock and DTS packet data from the Duty Cycle Shift Keyed(DCSK) timing signal.
...
\includegraphics[width=1\textwidth]{dune_timing_endpoint_block_dcsk_v2_17oct25-drawio.pdf}
...
Timing system firmware is stored in the CERN Gitlab repository at \url{https://gitlab.cern.ch/dune-daq/timing/dune-timing-firmware}. The endpoint code for each released version is uploaded to \url{https://pdts-fw.web.cern.ch/pdts-fw} as a compressed tar archive with a name that starts \texttt{bare\_endpoint\_tarball\_bare\_endpoint} .
